...
## Attribution
This repo contains [music](testapp/src/main/assets) sourced from [testapp](testapp/ module of this library contains music sourced from [Bensound](http://www.bensound.com/royalty-free-music/electronica). This music was licensed under the 'Creative Commons - Attribution - No Derivative Works' license and is not covered by the [licensing terms](LICENSE) of this library.
